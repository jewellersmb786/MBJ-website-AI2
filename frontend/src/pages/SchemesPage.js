...
const SchemesPage = () => (
  <div style={{ minHeight: '100vh', background: '#0f0f0f', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 32px', textAlign: 'center' }}>
    ...
    <h1 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', fontFamily: 'Georgia, serif', fontWeight: 400, color: '#fff', marginBottom: '16px' }}>Our Schemes</h1>
    ...
    <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.45)', maxWidth: '480px', lineHeight: 1.8, marginBottom: '40px' }}>
      Our jewellery savings schemes are coming soon. We are designing flexible and affordable plans to help you plan your dream purchase.
    </p>
    <Link to="/"
